                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <form method="POST" action="{{route('admin.course.update')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="text" value="{{$course->name}}" class="form-control" name="name" aria-label="With textarea">
                                        </div>
                                        ...
                                        <div class="input-group mb-4">
                                            ...
                                            <input type="number" value="{{$course->price}}" class="form-control" name="price" aria-label="With textarea">
                                        </div>
