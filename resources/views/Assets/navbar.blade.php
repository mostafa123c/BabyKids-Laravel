        ...
        <div class="nicdark_right_sidebar nicdark_bg_greydark nicdark_nicescrool">
            ...
            <div class="nicdark_textevidence">
                <div class="nicdark_margin20">
                    <ul class="nicdark_list nicdark_relative">
                        <li>
                            <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('EndUserAssets/img/woocommerce/small/img1.jpg')}}">
                        ...
                        <li>
                            <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('EndUserAssets/img/woocommerce/small/img3.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
            ...
            <div class="nicdark_textevidence">
                <div class="nicdark_margin20">
                    <ul class="nicdark_list nicdark_relative">
                        <li>
                            <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('EndUserAssets/img/woocommerce/small/img2.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
                        ...
                        <li>
                            <img alt=""  class="nicdark_absolute nicdark_radius nicdark_opacity nicdark_width60" src="{{asset('EndUserAssets/img/woocommerce/small/img4.jpg')}}">
                            <div class="nicdark_activity nicdark_marginleft80">
